...
function Message(props){
    ...
    return (
        <div className='message-block' style={{display: 'flex', flexDirection: type === "send" ? "row-reverse" : "row" }}>
            <div>
                ...
                <div className={`message-info ${type === "send" ? "sender" : "" }`}>
                    <img className="profile-pic" width="40px" height="40px" src={userImage(userData)} alt="..."/>
